...
for f in file:
    ...
    payload = "{'searchOptions':{'State':'','City':'','PostalCode':" + str(code) + ",'Category':'4',\"CountryCode\":\"\",\"Radius\":\"200\",\"IsUSASelected\":true,\"IsCANSelected\":false,\"IsINTSelected\":false}}"
    headers = {
    ...
    if len(dealers) >= 1:
        for dealer in dealers:
            ...
            temp.append(code)
            temp.append('Portable Generator Sales & Service')
            ...
            with open('cat3.csv', 'a+') as csvfile:
