...
for f in file:
    ...
    payload = "{'searchOptions':{'State':'','City':'','PostalCode':" + str(code) + ",'Category':'PW',\"CountryCode\":\"\",\"Radius\":\"200\",\"IsUSASelected\":true,\"IsCANSelected\":false,\"IsINTSelected\":false}}"
    headers = {
    ...
    if len(dealers) >= 1:
        for dealer in dealers:
            ...
            temp.append(code)
            temp.append('Power Washer Retailers')
            ...
            with open('cat7.csv', 'a+') as csvfile:
